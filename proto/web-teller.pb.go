...
var file_web_teller_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xf0, 0x05,
	...
	0x42, 0x18, 0x5a, 0x16, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x77, 0x65, 0x62, 0x2d, 0x74, 0x65,
...
var file_web_teller_proto_depIdxs = []int32{
	...
	1,  // 17: wtproto.WebTeller.Authentication:output_type -> wtproto.APIRES
	1,  // 18: wtproto.WebTeller.SessionValidate:output_type -> wtproto.APIRES
	1,  // 19: wtproto.WebTeller.PaymentInquiry:output_type -> wtproto.APIRES
	1,  // 20: wtproto.WebTeller.PaymentPosting:output_type -> wtproto.APIRES
	1,  // 21: wtproto.WebTeller.BulkPaymentPosting:output_type -> wtproto.APIRES
	1,  // 22: wtproto.WebTeller.TransferInquiry:output_type -> wtproto.APIRES
	1,  // 23: wtproto.WebTeller.TransferPosting:output_type -> wtproto.APIRES
	1,  // 24: wtproto.WebTeller.TransactionReport:output_type -> wtproto.APIRES
	1,  // 25: wtproto.WebTeller.CashTellerInquiry:output_type -> wtproto.APIRES
	1,  // 26: wtproto.WebTeller.InquiryNomorRekening:output_type -> wtproto.APIRES
	1,  // 27: wtproto.WebTeller.UpdateCetak:output_type -> wtproto.APIRES
	1,  // 28: wtproto.WebTeller.ReInquiryMPN:output_type -> wtproto.APIRES
	1,  // 29: wtproto.WebTeller.InquirySiskohat:output_type -> wtproto.APIRES
	1,  // 30: wtproto.WebTeller.ReportMpnAll:output_type -> wtproto.APIRES
