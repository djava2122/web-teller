...
var file_web_teller_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xff, 0x07,
	...
	0x74, 0x6f, 0x2e, 0x41, 0x50, 0x49, 0x52, 0x45, 0x51, 0x1a, 0x0f, 0x2e, 0x77, 0x74, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x50, 0x49, 0x52, 0x45, 0x53, 0x12, 0x33, 0x0a, 0x0f, 0x49, 0x6e,
	0x71, 0x75, 0x69, 0x72, 0x79, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x12, 0x0f, 0x2e,
	0x77, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x50, 0x49, 0x52, 0x45, 0x51, 0x1a, 0x0f,
	0x2e, 0x77, 0x74, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x50, 0x49, 0x52, 0x45, 0x53, 0x42,
	0x18, 0x5a, 0x16, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x77, 0x65, 0x62, 0x2d, 0x74, 0x65, 0x6c,
...
var file_web_teller_proto_depIdxs = []int32{
	...
	0,  // 21: wtproto.WebTeller.InquiryPackages:input_type -> wtproto.APIREQ
	1,  // 22: wtproto.WebTeller.Authentication:output_type -> wtproto.APIRES
	1,  // 23: wtproto.WebTeller.SessionValidate:output_type -> wtproto.APIRES
	1,  // 24: wtproto.WebTeller.PaymentInquiry:output_type -> wtproto.APIRES
	1,  // 25: wtproto.WebTeller.PaymentPosting:output_type -> wtproto.APIRES
	1,  // 26: wtproto.WebTeller.BulkPaymentPosting:output_type -> wtproto.APIRES
	1,  // 27: wtproto.WebTeller.TransferInquiry:output_type -> wtproto.APIRES
	1,  // 28: wtproto.WebTeller.TransferPosting:output_type -> wtproto.APIRES
	1,  // 29: wtproto.WebTeller.TransactionReport:output_type -> wtproto.APIRES
	1,  // 30: wtproto.WebTeller.CashTellerInquiry:output_type -> wtproto.APIRES
	1,  // 31: wtproto.WebTeller.InquiryNomorRekening:output_type -> wtproto.APIRES
	1,  // 32: wtproto.WebTeller.UpdateCetak:output_type -> wtproto.APIRES
	1,  // 33: wtproto.WebTeller.ReInquiryMPN:output_type -> wtproto.APIRES
	1,  // 34: wtproto.WebTeller.InquirySiskohat:output_type -> wtproto.APIRES
	1,  // 35: wtproto.WebTeller.ReportMpnAll:output_type -> wtproto.APIRES
	1,  // 36: wtproto.WebTeller.LoginSiskopatuh:output_type -> wtproto.APIRES
	1,  // 37: wtproto.WebTeller.GetBranchTeller:output_type -> wtproto.APIRES
	1,  // 38: wtproto.WebTeller.DownloadFileReport:output_type -> wtproto.APIRES
	1,  // 39: wtproto.WebTeller.GenerateFileReport:output_type -> wtproto.APIRES
	1,  // 40: wtproto.WebTeller.InquiryPackages:output_type -> wtproto.APIRES
